    ...
    return __generator(this, function (_o) {
        switch (_o.label) {
            ...
            case 1:
                ...
                try {
                    returnComparator = function () {
                        return result_1.DBSnapshots.length == 0.0;
                    };
            ...
            case 2:
                exception_1 = _o.sent();
                reason = exception_1;
                if (exception_1.name && exception_1.name == "DBSnapshotNotFound") {
                    return [2, { state: WaiterState.SUCCESS, reason: reason }];
                }
                return [3, 3];
...
export var waitForDBSnapshotDeleted = function (params, input) { return __awaiter(void 0, void 0, void 0, function () {
    var serviceDefaults;
